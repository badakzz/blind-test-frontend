...
export const usePlaylistManager = (playlistId, currentChatroom, csrfToken) => {
            ...
            const updateCurrentSongPlaying = async () => {
                try {
                    const response = await axios.put(
                        `${process.env.REACT_APP_SERVER_DOMAIN}:${process.env.REACT_APP_SERVER_PORT}/api/v1/chatrooms/${currentChatroom.chatroom_id}/current_song_playing_id`,
