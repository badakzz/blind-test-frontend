    ...
    return (
        <>
            ...
            >
                <Navbar.Brand
                    onClick={() => navigate('/')}
                    className="d-flex align-items-center justify-content-between text-black py-0 gap-5 custom-navbrand"
                >
                    <Image
                        src={logo}
                        width="80"
                ...
                >
                    {user.user && (
                        <div className="d-flex align-items-center gap-3 flex-grow text-black custom-spacing-icon">
                            ...
                            <Nav.Item
                                ...
                                className="d-lg-none flex-grow text-black"
                            >
                                Play
                            </Nav.Item>
                        </div>
