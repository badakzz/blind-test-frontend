                        ...
                        <div>
                            {user?.permissions !== 2 ? (
                                <>
                                    ...
                                    <p>
                                        Bored of using the same playlists over
                                        and over again? For 5€, unlock the
                                        premium membership for life, and start
                                        browsing to Spotify, select and play
                                ...
                                <div className="d-flex flex-column md-5 mb-3">
                                    ...
                                    <p className="d-flex flex-column justify-content-between text-justify">
                                        ...
                                        Spotify playlists you want in your
                                        games, enjoy!
                                    </p>
                                </div>
                            )}
